...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *xpanxion-dev-essentials.web.api*):

Restore dependencies
```
    cd "xpanxion-dev-essentials.web.api"
    dotnet restore
```

Execute unit tests
```
    cd "xpanxion-dev-essentials.web.api/test/xpanxion-dev-essentials.web.api.Tests"
    dotnet test
```

Deploy application
```
    cd "xpanxion-dev-essentials.web.api/src/xpanxion-dev-essentials.web.api"
